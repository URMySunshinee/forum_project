...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
                                        ...
                                        <!-- Ví dụ cập nhật thanh điều hướng -->
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <!-- Nút thu gọn trên thiết bị di động -->
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <!-- Kiểm tra nếu người dùng là moderator -->
                @role('moderator')
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('moderator.dashboard') }}">Quản trị nội dung</a>
                    </li>
                @endrole
            </ul>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @guest
                    ...
                    @endif
                @else
                    <!-- Hiển thị tên người dùng và menu tài khoản -->
